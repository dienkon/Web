...
export default function ElementQuizGame({ question }: { question: any }) {
  ...
  return (
    <div className="w-full max-w-4xl flex flex-col items-center">
      <h3 className="text-xl md:text-2xl font-bold text-slate-600 dark:text-slate-300 mb-6 text-center">Đoán Ký Hiệu / Tên Nguyên Tố Hóa Học:</h3>
      ...
      <div className="bg-white/90 dark:bg-slate-900/90 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-inner w-full flex flex-col items-center justify-center gap-4 overflow-hidden">
        <div className="w-full text-xl md:text-2xl font-bold text-amber-600 dark:text-amber-400 text-center leading-relaxed flex items-center justify-center flex-wrap break-words whitespace-normal">
          {question.equation || question.prompt || 'Nguyên tố Z=1'}
        </div>
      </div>
      ...
      <div className="mt-8 w-full max-w-md">
        <input
          type="text"
          placeholder="Ký hiệu (ví dụ: Fe, Au, H) hoặc Tên nguyên tố..."
