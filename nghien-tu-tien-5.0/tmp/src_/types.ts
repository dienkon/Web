...
export type EquipmentSlot = 'weapon' | 'head' | 'armor' | 'boots' | 'ring' | 'necklace' | 'artifact' | 'wings';

export type ItemRarity = 'Trắng' | 'Lục' | 'Lam' | 'Tím' | 'Cam' | 'Đỏ' | 'Thần Thoại' | 'Tiên Khí';
...
export interface GameItem {
  ...
  baseId?: string;
  name: string;
  type: 'consumable' | 'herb' | 'ore' | 'material' | 'enhancement' | 'gem' | 'artifact' | 'manual' | 'key' | 'special' | 'currency' | 'equipment';
  rarity: ItemRarity;
  quality?: ItemQuality;
  desc: string;
  count: number;
