                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    onClick={async (e) => {
                      ...
                      if (
                        confirm(
                          `Bạn có chắc chắn muốn xóa "${section.title}"? Các câu hỏi trong phần này sẽ được chuyển thành câu hỏi tự do.`
                        )
                      ) {
                        await deleteSection(examId, section.id);
                              ...
                              <button 
                                onClick={async () => {
                                  if (confirm("Xóa câu hỏi này?")) {
                                    ...
                                    setQuestions(prev => ({
                                      ...prev,
                                      [section.id]: prev[section.id].filter(oldQ => oldQ.id !== q.id)
                                    }));
                                  }
                                }}
